...
/* @var $searchModel backend\models\IzinTdpKantorSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Izin Tdp Kantor';
...
?>
<div class="izin-tdp-kantor-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Create Izin Tdp Kantor', ['create'], ['class' => 'btn btn-success']) ?>
