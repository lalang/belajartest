    ...
    'attributes' => [
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete <i class="fa fa-trash"></i>'), 'onClick' => 'delRowRegistrasi(' . $key . '); return false;', 'id' => 'registrasi-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
