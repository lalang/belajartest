...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'pengambilan_jam' => ['type' => TabularForm::INPUT_WIDGET,
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete <i class="fa fa-trash"></i>'), 'onClick' => 'delRowPerizinan(' . $key . '); return false;', 'id' => 'perizinan-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            'heading' => '<h3 class="panel-title"><i class="fa fa-book"></i> ' . Yii::t('app', 'Perizinan') . '  </h3>',
