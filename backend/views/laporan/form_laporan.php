	...
	<div class="panel-body">
		<?php $form = ActiveForm::begin(); ?>
			<div class="row">
				...
				<div class="col-md-3" id='wewenang'>
					<div class="row">
						<div class="col-md-12">
							<?php
								echo $form->field($model, 'pilih_kesehatan')->dropDownList(['1' => 'Dokter Umum', '2' => 'Dokter Gigi', '3' => 'Perawat', '4' => 'Perawat Gigi','5' => 'Bidan', 'Dokter Hewan','6' => 'Dokter Hewan'],['prompt'=>'Pilih Jenis SIP'])->label('Jenis SIP');
							?>
						</div>
					</div>	
				</div>
...
$(document).ready(function() {
	$('#wewenang').hide();
	$('#perizinan-id_laporan').change(function() {
		if ($('#perizinan-id_laporan').val() == '8') {
			$('#wewenang').show();
		} else {
			$('#wewenang').hide();
		}
	...
	$('form').on('submit', function() {
		...
		if ($('#perizinan-id_laporan').val() == '8') {
			if(!$('#perizinan-pilih_kesehatan').val()) {
				alert('Silakan pilih wewenang');
				$('#perizinan-pilih_kesehatan').focus();
				return false;
			}
		} 
