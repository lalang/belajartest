...
<header class="main-header">
    ...
    <img class="main-header logo" src="<?= Yii::getAlias('@web') ?>/images/logo-dki-small.png" style="padding-left: 30px; margin-left: -31px; background:none;border:none; width:auto;height:auto;margin-right:-77px">
