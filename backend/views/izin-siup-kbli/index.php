...
/* @var $searchModel backend\models\IzinSiupKbliSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Izin Siup Kbli');
...
?>
<div class="izin-siup-kbli-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Izin Siup Kbli <i class="fa fa-plus"></i>'), ['create'], ['class' => 'btn btn-success']) ?>
