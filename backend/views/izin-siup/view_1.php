...
<section id="page-content">
    <div class="panel">
        ...
        <div class="pull-right" style="right:10%;">
            <?=
            Html::a(Yii::t('app', '<i class="fa fa-chevron-left"></i> '), Yii::$app->request->referrer, [
                'class' => 'btn btn-circle btn-danger',
                'data-toggle' => 'tooltip',
                'title' => Yii::t('app', 'Kembali ke Mekanisme Pelayanan')
            ])
            ?>
            <?=
            Html::a('<i class="fa fa-file-pdf-o"></i> ', ['pdf', 'id' => $model['id']], [
                'class' => 'btn btn-circle btn-danger',
                'target' => '_blank',
                'data-toggle' => 'tooltip',
