...
/* @var $searchModel backend\models\IzinSiupAktaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Izin Siup Akta');
...
?>
<div class="izin-siup-akta-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Izin Siup Akta <i class="fa fa-plus"></i>'), ['create'], ['class' => 'btn btn-success']) ?>
