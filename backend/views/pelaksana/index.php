...
/* @var $searchModel backend\models\PelaksanaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Pelaksana');
...
<section id="page-content">
	...
	<div class="pelaksana-index">

		<?php // echo $this->render('_search', ['model' => $searchModel]); ?>

		<p>
			<?= Html::a(Yii::t('app', 'Create Pelaksana <i class="fa fa-plus"></i>'), ['create'], ['class' => 'btn btn-success']) ?>
