...
/* @var $searchModel backend\models\WewenangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Wewenang');
...
<section id="page-content">
	...
	<div class="wewenang-index">

		<?php // echo $this->render('_search', ['model' => $searchModel]); ?>

		<p>
			<?= Html::a(Yii::t('app', 'Create Wewenang <i class="fa fa-plus"></i>'), ['create'], ['class' => 'btn btn-success']) ?>
