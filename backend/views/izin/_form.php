...
<div class="izin-form">
    ...
    <?= $form->field($model, 'bidang_izin_id')->dropDownList(\backend\models\BidangIzinUsaha::getDataList(),['id' => 'bidang-id', 'class' => 'input-large form-control', 'prompt' => 'Pilih Bidang Usaha..']);?>
    
    <?php echo Html::hiddenInput('jenis_usaha_id', $model->jenis_usaha_id, ['id' => 'model_id1']); ?>
    <?=
    $form->field($model, 'jenis_usaha_id')->widget(\kartik\widgets\DepDrop::classname(), [
        'options' => ['id' => 'jenis-id'],
        'pluginOptions' => [
            'depends' => ['bidang-id'],
    ...
    ?>
    <?php echo Html::hiddenInput('sub_jenis_id', $model->sub_jenis_id, ['id' => 'model_id2']); ?>
    <?=
    $form->field($model, 'sub_jenis_id')->widget(\kartik\widgets\DepDrop::classname(), [
        'pluginOptions' => [
            'depends' => ['jenis-id'],
