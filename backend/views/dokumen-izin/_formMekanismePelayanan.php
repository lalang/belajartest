    ...
    'attributes' => [
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete <i class="fa fa-trash"></i>'), 'onClick' => 'delRowMekanismePelayanan(' . $key . '); return false;', 'id' => 'mekanisme-pelayanan-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            'heading' => '<h3 class="panel-title"><i class="fa fa-book"></i> ' . Yii::t('app', 'Mekanisme Pelayanan') . '  </h3>',
