...
<div class="zonasi-form">
    ...
    <?= $form->field($model, 'zonasi')->textInput(['maxlength' => true, 'placeholder' => 'Zonasi']) ?>

    <?= $form->field($model, 'rdtr')->textInput(['maxlength' => true, 'placeholder' => 'Rdtr']) ?>
