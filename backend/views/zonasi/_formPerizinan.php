...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'status_izin' => ['type' => TabularForm::INPUT_DROPDOWN_LIST,
                    'options' => [
                        'items' => [ 'Baru' => 'Baru', 'Perpanjangan' => 'Perpanjangan', 'Perubahan' => 'Perubahan', ],
                        'columnOptions => ['width' => '185px'],
                        'options' => ['placeholder' => Yii::t('app', 'Choose Status Izin')],
                    ]
        ],
        ...
        'status' => ['type' => TabularForm::INPUT_DROPDOWN_LIST,
                    'options' => [
                        'items' => [ 'Daftar' => 'Daftar', 'Proses' => 'Proses', 'Tolak' => 'Tolak', 'Revisi' => 'Revisi', 'Lanjut' => 'Lanjut', 'Selesai' => 'Selesai', 'Batal' => 'Batal', 'Verifikasi' => 'Verifikasi', ],
                        'columnOptions => ['width' => '185px'],
        ...
        'alamat_valid' => ['type' => TabularForm::INPUT_DROPDOWN_LIST,
                    'options' => [
                        'items' => [ 'Ya' => 'Ya', 'Virtual Office' => 'Virtual Office', ],
                        'columnOptions => ['width' => '185px'],
                        'options' => ['placeholder' => Yii::t('app', 'Choose Alamat Valid')],
                    ]
        ],
        'del' => [
