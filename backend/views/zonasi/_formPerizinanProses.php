...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'action' => ['type' => TabularForm::INPUT_TEXTAREA],
        'pelaksana_id' => [
            'label' => 'Pelaksana',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
        ...
        'status' => ['type' => TabularForm::INPUT_DROPDOWN_LIST,
                    'options' => [
                        'items' => [ 'Daftar' => 'Daftar', 'Proses' => 'Proses', 'Tolak' => 'Tolak', 'Revisi' => 'Revisi', 'Lanjut' => 'Lanjut', 'Selesai' => 'Selesai', 'Batal' => 'Batal', 'Berkas Siap' => 'Berkas Siap', ],
