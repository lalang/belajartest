        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="mini-stat clearfix bg-facebook rounded">
                    <span class="mini-stat-icon"><i class="fa fa-envelope fg-envelope"></i></span>
                    <div class="mini-stat-info">
                        <span><?= Perizinan::getTotal(); ?></span>
                        Total Permohonan
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="mini-stat clearfix bg-twitter rounded">
                    <span class="mini-stat-icon"><i class="fa fa-check fg-check"></i></span>
                    <div class="mini-stat-info">
                        <span><?= Perizinan::getFinish(); ?></span>
                        Permohonan Selesai
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="mini-stat clearfix bg-bitbucket rounded">
                    <span class="mini-stat-icon"><i class="fa fa-plus fg-plus"></i></span>
                    <div class="mini-stat-info">
                        <span><?= Perizinan::getNew(); ?></span>
                        Permohonan Baru
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="mini-stat clearfix bg-googleplus rounded">
                    <span class="mini-stat-icon"><i class="fa fa-remove fg-remove"></i></span>
                    <div class="mini-stat-info">
                        <span><?= Perizinan::getRejected(); ?></span>
                        Permohonan Ditolak
                    </div>
                </div>
            </div>
