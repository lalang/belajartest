...
/* @var $searchModel backend\models\KbliSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Kbli');
...
<section id="page-content">
	...
	<div class="kbli-index">

		<?php // echo $this->render('_search', ['model' => $searchModel]); ?>

		<p>
			<?= Html::a(Yii::t('app', 'Create Kbli <i class="fa fa-plus"></i>'), ['create'], ['class' => 'btn btn-success']) ?>
