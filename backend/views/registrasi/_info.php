...
<table class="table">
    <tr>
        ...
        <td><?= Yii::t('user', ''.gmdate("d-M-Y H:i:s", $user->created_at).'') ?></td>
    </tr>
    ...
    <tr>
        ...
        <?php if ($user->isConfirmed): ?>
            <td class="text-success"><?= Yii::t('user', 'Confirmed at '.gmdate("d-M-Y H:i:s", $user->confirmed_at).'') ?></td>
        <?php else: ?>
    ...
    <tr>
        ...
        <?php if ($user->isBlocked): ?>
            <td class="text-danger"><?= Yii::t('user', 'Blocked at '.gmdate("d-M-Y H:i:s", $user->blocked_at).'') ?></td>
        <?php else: ?>
