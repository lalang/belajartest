...
class IzinPm1 extends BaseIzinPm1 {
    ...
    public function rules() {
        return [
            [['izin_id', 'user_id', 'status_id', 'nik', 'no_kk', 'nama', 'agama', 'tempat_lahir', 'tanggal_lahir', 'jenkel', 'alamat', 'kodepos', 'pekerjaan', 'kelurahan_id', 'instansi_tujuan'], 'required'],
...
//                die();
    ...
    public function afterFind() {
        ...
        $alamat_lengkap = $this->alamat.' Kel.'.$this->nama_kelurahan.' Kec.'.$this->nama_kecamatan.' Kab.'.$this->nama_kabkota.', DKI Jakarta';
