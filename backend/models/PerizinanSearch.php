...
class PerizinanSearch extends Perizinan {
    ...
    public function rules() {
        return [
            ...
            [['cari', 'pemohon_id', 'izin_id', 'tanggal_mohon', 'no_izin', 'berkas_noizin', 'tanggal_izin', 'tanggal_expired', 'status', 'aktif', 'registrasi_urutan', 'action', 'pelaksana_id', 'peruntukan', 'nourut_proses', 'tanggal_cek_lapangan', 'petugas_cek', 'status_daftar', 'keterangan', 'qr_code', 'tanggal_pertemuan', 'pengambilan_tanggal', 'pengambilan_sesi', 'create_date', 'update_date', 'kode_registrasi'], 'safe'],
        ];
    }
     ...
     */
    public function search($params, $plh_id = null) {
        $this->load($params);
...
//        $query->joinWith('izin')->andWhere('izin.wewenang_id = ' . Yii::$app->user->identity->wewenang_id);
    ...
    public function searchPencabutanAktif($params, $plh_id = null) {
        $this->load($params);
        $query = Perizinan::find();
