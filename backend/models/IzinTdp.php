...
class IzinTdp extends BaseIzinTdp {
     ...
     * @inheritdoc
     */
    public function rules() {//[['i_4_pemilik_telepon','ii_2_perusahaan_no_telp','ii_2_perusahaan_no_fax'],'string', 'max' => 15],
        return [
...
//                }
    ...
    public function afterFind() {
        ...
        $this->nama_kelurahan = Lokasi::findOne(['id' => $this->ii_2_perusahaan_kelurahan])->nama;
        $this->nama_kecamatan = Lokasi::findOne(['id' => $this->ii_2_perusahaan_kecamatan])->nama;
        $this->nama_kabkota = Lokasi::findOne(['id' => $this->ii_2_perusahaan_kabupaten])->nama;
...
//        die(print_r($kb));
        ...
        switch ($this->iii_8_bentuk_kerjasama_pihak3) {
            case 1: $btk_kerja = 'Jaringan Internasional';
                break;
            case 2: $btk_kerja = 'Jaringan Nasional';
                break;
            case 3: $btk_kerja = 'Waralaba Internasional';
                break;
            case 4: $btk_kerja = 'Waralaba Internasional';
                break;
            case 5: $btk_kerja = 'KSO';
                break;
            case 6: $btk_kerja = 'Mandiri';
                break;
        }
