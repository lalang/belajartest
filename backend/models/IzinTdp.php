...
class IzinTdp extends BaseIzinTdp
{
    ...
    {
        return [
            [['bentuk_perusahaan', 'perizinan_id', 'izin_id', 'user_id', 'status_id', 'lokasi_id', 'perpanjangan_ke', 
              ...
              'ii_2_perusahaan_email', 'iii_1_nama_kelompok', 'iii_3_lokasi_unit_produksi', 'iii_4_bank_utama_1', 'iii_4_jumlah_bank', 
              'iii_5_npwp', 'iii_6_status_perusahaan_id', 'iii_7a_tgl_pendirian', 'iii_7b_tgl_mulai_kegiatan', 
              'iii_8_bentuk_kerjasama_pihak3', 'iv_a1_nomor', 'iv_a1_tanggal', 'iv_a1_notaris_nama', 'iv_a1_notaris_alamat', 
