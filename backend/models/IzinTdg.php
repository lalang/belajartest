...
class IzinTdg extends BaseIzinTdg
{
    ...
    public function rules()
    {
        return [
			...
			[['pemilik_kodepos','perusahaan_kodepos','gudang_kodepos','hs_per_kodepos','hs_kodepos'], 'string', 'max' => 8],
