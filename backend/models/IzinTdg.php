...
class IzinTdg extends BaseIzinTdg
{
    ...
    {
        return [
            [['perizinan_id', 'izin_id', 'status_id', 'create_by', 'create_date','pemilik_nik','pemilik_paspor','pemilik_kitas','pemilik_nama','pemilik_alamat','pemilik_rt','pemilik_rw','pemilik_kabupaten','pemilik_kodepos','pemilik_telepon','pemilik_fax','pemilik_email','perusahaan_npwp','perusahaan_nama','perusahaan_namagedung','perusahaan_blok_lantai','perusahaan_namajalan','perusahaan_kabupaten','perusahaan_kodepos','perusahaan_telepon','perusahaan_fax','perusahaan_email','gudang_koordinat_1','gudang_koordinat_2','gudang_namagedung','gudang_blok_lantai','gudang_namajalan','gudang_rt','gudang_rw','gudang_kabupaten','gudang_kodepos','gudang_telepon','gudang_fax','gudang_email','gudang_luas','gudang_kapasitas','gudang_kapasitas_satuan','gudang_nilai','gudang_komposisi_nasional','gudang_komposisi_asing','gudang_kelengkapan','gudang_sarana_listrik','gudang_sarana_air','gudang_sarana_pendingin','gudang_sarana_forklif','gudang_sarana_komputer','gudang_kepemilikan','gudang_imb_nomor','gudang_imb_tanggal','gudang_uug_nomor','gudang_uug_tanggal','gudang_uug_berlaku','gudang_isi'], 'required'],
