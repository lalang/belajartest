...
/**
 * This is the base model class for table "izin_kesehatan_jadwal".
 *
 * @property integer $id
 ...
 */
class IzinKesehatanJadwal extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\IzinKesehatanJadwalQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\IzinKesehatanJadwalQuery(get_called_class());
    }
}
