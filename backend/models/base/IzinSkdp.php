 ...
 * @property integer $jumlah_kariawan
...
class IzinSkdp extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['perizinan_id', 'izin_id', 'user_id', 'status_id', 'wilayah_id', 'kecamatan_id', 'kelurahan_id', 'kewarganegaraan_id', 'wilayah_id_perusahaan', 'kecamatan_id_perusahaan', 'kelurahan_id_perusahaan', 'jumlah_kariawan', 'nomor_akta_pendirian', 'nomor_sk_kemenkumham'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'rt_perusahaan' => Yii::t('app', 'Rt Perusahaan'),
            'rw_perusahaan' => Yii::t('app', 'Rw Perusahaan'),
            ...
            'jumlah_kariawan' => Yii::t('app', 'Jumlah Kariawan'),
