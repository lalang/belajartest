...
class IzinKesehatan extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'wilayah_id' => Yii::t('app', 'Wilayah ID'),
            ...
            'nomor_str' => Yii::t('app', 'Nomor Str'),
            'tanggal_berlaku_str' => Yii::t('app', 'Tanggal Berlaku Str'),
            'perguruan_tinggi' => Yii::t('app', 'Perguruan Tinggi'),
            'tanggal_lulus' => Yii::t('app', 'Tanggal Lulus'),
            'nomor_rekomendasi' => Yii::t('app', 'Nomor Rekomendasi'),
            'kepegawaian_id' => Yii::t('app', 'Kepegawaian ID'),
            'nomor_fasilitas_kesehatan' => Yii::t('app', 'Nomor Fasilitas Kesehatan'),
            'tanggal_fasilitas_kesehatan' => Yii::t('app', 'Tanggal Fasilitas Kesehatan'),
            'nomor_pimpinan' => Yii::t('app', 'Nomor Pimpinan'),
            'tanggal_pimpinan' => Yii::t('app', 'Tanggal Pimpinan'),
            ...
            'nama_gedung_praktik' => Yii::t('app', 'Nama Gedung Praktik'),
            'blok_tempat_praktik' => Yii::t('app', 'Blok Tempat Praktik'),
            'alamat_tempat_praktik' => Yii::t('app', 'Alamat Tempat Praktik'),
            'rt_tempat_praktik' => Yii::t('app', 'Rt Tempat Praktik'),
            'rw_tempat_praktik' => Yii::t('app', 'Rw Tempat Praktik'),
            'wilayah_id_tempat_praktik' => Yii::t('app', 'Wilayah Id Tempat Praktik'),
            'kecamatan_id_tempat_praktik' => Yii::t('app', 'Kecamatan Id Tempat Praktik'),
            'kelurahan_id_tempat_praktik' => Yii::t('app', 'Kelurahan Id Tempat Praktik'),
            'kodepos_tempat_praktik' => Yii::t('app', 'Kodepos Tempat Praktik'),
            'telpon_tempat_praktik' => Yii::t('app', 'Telpon Tempat Praktik'),
            'fax_tempat_praktik' => Yii::t('app', 'Fax Tempat Praktik'),
            'email_tempat_praktik' => Yii::t('app', 'Email Tempat Praktik'),
            'nomor_izin_kesehatan' => Yii::t('app', 'Nomor Izin Kesehatan'),
            'jenis_praktik_i' => Yii::t('app', 'Jenis Praktik I'),
            'nama_tempat_praktik_i' => Yii::t('app', 'Nama Tempat Praktik I'),
            'nomor_sip_i' => Yii::t('app', 'Nomor Sip I'),
            'tanggal_berlaku_sip_i' => Yii::t('app', 'Tanggal Berlaku Sip I'),
            'nama_gedung_praktik_i' => Yii::t('app', 'Nama Gedung Praktik I'),
            'blok_tempat_praktik_i' => Yii::t('app', 'Blok Tempat Praktik I'),
            'alamat_tempat_praktik_i' => Yii::t('app', 'Alamat Tempat Praktik I'),
            'rt_tempat_praktik_i' => Yii::t('app', 'Rt Tempat Praktik I'),
            'rw_tempat_praktik_i' => Yii::t('app', 'Rw Tempat Praktik I'),
            'propinsi_id_tempat_praktik_i' => Yii::t('app', 'Propinsi Id Tempat Praktik I'),
            'wilayah_id_tempat_praktik_i' => Yii::t('app', 'Wilayah Id Tempat Praktik I'),
            'kecamatan_id_tempat_praktik_i' => Yii::t('app', 'Kecamatan Id Tempat Praktik I'),
            'kelurahan_id_tempat_praktik_i' => Yii::t('app', 'Kelurahan Id Tempat Praktik I'),
            'telpon_tempat_praktik_i' => Yii::t('app', 'Telpon Tempat Praktik I'),
            'jenis_praktik_ii' => Yii::t('app', 'Jenis Praktik Ii'),
            'nama_tempat_praktik_ii' => Yii::t('app', 'Nama Tempat Praktik Ii'),
            'nomor_sip_ii' => Yii::t('app', 'Nomor Sip Ii'),
            'tanggal_berlaku_sip_ii' => Yii::t('app', 'Tanggal Berlaku Sip Ii'),
            'nama_gedung_praktik_ii' => Yii::t('app', 'Nama Gedung Praktik Ii'),
            'blok_tempat_praktik_ii' => Yii::t('app', 'Blok Tempat Praktik Ii'),
            'alamat_tempat_praktik_ii' => Yii::t('app', 'Alamat Tempat Praktik Ii'),
            'rt_tempat_praktik_ii' => Yii::t('app', 'Rt Tempat Praktik Ii'),
            'rw_tempat_praktik_ii' => Yii::t('app', 'Rw Tempat Praktik Ii'),
            'propinsi_id_tempat_praktik_ii' => Yii::t('app', 'Propinsi Id Tempat Praktik Ii'),
            'wilayah_id_tempat_praktik_ii' => Yii::t('app', 'Wilayah Id Tempat Praktik Ii'),
            'kecamatan_id_tempat_praktik_ii' => Yii::t('app', 'Kecamatan Id Tempat Praktik Ii'),
            'kelurahan_id_tempat_praktik_ii' => Yii::t('app', 'Kelurahan Id Tempat Praktik Ii'),
            'telpon_tempat_praktik_ii' => Yii::t('app', 'Telpon Tempat Praktik Ii'),
        ];
    }
