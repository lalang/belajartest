...
class IzinTdp extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'vi_c_modal_1d'=> Yii::t('app', 'Hibah'),
            'vi_c_modal_2a'=> Yii::t('app','Anggota'),
            'vi_c_modal_2b'=> Yii::t('app', 'Koprasi lain'),
            'vi_c_modal_2c'=> Yii::t('app', 'Bank'),
            'vi_c_modal_2d'=> Yii::t('app', 'Lainnya'),
            ...
            'vii_c6_aktif' => Yii::t('app', 'Modal Distor Aktif'),
            'vii_c7_pasif' => Yii::t('app', 'Modal Distor Pasif'),
