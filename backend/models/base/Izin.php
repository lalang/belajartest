...
class Izin extends \yii\db\ActiveRecord {
    ...
    public function attributeLabels() {
        return [
            ...
            'wewenang_id' => Yii::t('app', 'Wewenang'),
    ...
    public function getDokumenPersyaratan() {
        return $this->hasMany(\backend\models\DokumenPendukung::className(), ['izin_id' => 'id'])->andWhere(['kategori' => 'Persyaratan Izin']);
    }
