...
class IzinPariwisata extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'propinsi_id_perusahaan' => Yii::t('app', 'Propinsi Perusahaan'),
            ...
            'propinsi_id_penanggung_jawab' => Yii::t('app', 'Propinsi Penanggung Jawab'),
            'wilayah_id_penanggung_jawab' => Yii::t('app', 'Wilayah Penanggung Jawab'),
            'kecamatan_id_penanggung_jawab' => Yii::t('app', 'Kecamatan Penanggung Jawab'),
            'kelurahan_id_penanggung_jawab' => Yii::t('app', 'Kelurahan  Penanggung Jawab'),
            ...
            'wilayah_id_usaha' => Yii::t('app', 'Wilayah Usaha'),
