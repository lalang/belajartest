...
class IzinPariwisata extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'propinsi_id_perusahaan' => Yii::t('app', 'Propinsi Id Perusahaan'),
            'wilayah_id_perusahaan' => Yii::t('app', 'Wilayah Id Perusahaan'),
            'kecamatan_id_perusahaan' => Yii::t('app', 'Kecamatan Id Perusahaan'),
            'kelurahan_id_perusahaan' => Yii::t('app', 'Kelurahan Id Perusahaan'),
            ...
            'tanggal_cabang' => Yii::t('app', 'Tanggal Cabang'),
            ...
            'identitas_sama' => Yii::t('app', 'Identitas Sama'),
            ...
            'jenkel_penanggung_jawab' => Yii::t('app', 'Jenkel Penanggung Jawab'),
            'alamat_penanggung_jawab' => Yii::t('app', 'Alamat Penanggung Jawab'),
            'rt_penanggung_jawab' => Yii::t('app', 'Rt Penanggung Jawab'),
            'rw_penanggung_jawab' => Yii::t('app', 'Rw Penanggung Jawab'),
            'propinsi_id_penanggung_jawab' => Yii::t('app', 'Propinsi Id Penanggung Jawab'),
            'wilayah_id_penanggung_jawab' => Yii::t('app', 'Wilayah Id Penanggung Jawab'),
            'kecamatan_id_penanggung_jawab' => Yii::t('app', 'Kecamatan Id Penanggung Jawab'),
            'kelurahan_id_penanggung_jawab' => Yii::t('app', 'Kelurahan Id Penanggung Jawab'),
            'kodepos_penanggung_jawab' => Yii::t('app', 'Kodepos Penanggung Jawab'),
            'telepon_penanggung_jawab' => Yii::t('app', 'Telepon Penanggung Jawab'),
            'kewarganegaraan_id_penanggung_jawab' => Yii::t('app', 'Kewarganegaraan Id Penanggung Jawab'),
            'kitas_penanggung_jawab' => Yii::t('app', 'Kitas Penanggung Jawab'),
            'passport_penanggung_jawab' => Yii::t('app', 'Passport Penanggung Jawab'),
            'no_tdup' => Yii::t('app', 'No Tdup'),
            ...
            'rt_usaha' => Yii::t('app', 'Rt Usaha'),
            'rw_usaha' => Yii::t('app', 'Rw Usaha'),
            'wilayah_id_usaha' => Yii::t('app', 'Wilayah Id Usaha'),
            'kecamatan_id_usaha' => Yii::t('app', 'Kecamatan Id Usaha'),
            'kelurahan_id_usaha' => Yii::t('app', 'Kelurahan Id Usaha'),
            'kodepos_usaha' => Yii::t('app', 'Kodepos Usaha'),
            'telpon_usaha' => Yii::t('app', 'Telpon Usaha'),
