...
/**
 * This is the base model class for table "izin_kesehatan_jadwal_satu".
 *
 * @property integer $id
 ...
 */
class IzinKesehatanJadwalSatu extends \yii\db\ActiveRecord
{
    ...
    {
        return 'izin_kesehatan_jadwal_satu';
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\models\IzinKesehatanJadwalSatuQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\IzinKesehatanJadwalSatuQuery(get_called_class());
    }
}
