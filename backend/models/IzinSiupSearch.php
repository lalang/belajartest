...
/**
 * backend\models\IzinSiupSearch represents the model behind the search form about `backend\models\IzinSiup`.
 */
 class IzinSiupSearch extends IzinSiup
{
    ...
    {
        return [
            [['id', 'perizinan_id', 'izin_id', 'user_id', 'kelurahan_id'], 'integer'],
