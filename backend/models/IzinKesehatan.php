...
//                }
    ...
    public function afterFind() {
        ...
        $this->nama_kabkota_i = Lokasi::findOne(['id' => $this->wilayah_id_tempat_praktik_i])->nama;
        $this->nama_kabkota_ii = Lokasi::findOne(['id' => $this->wilayah_id_tempat_praktik_ii])->nama;
        $this->nama_propinsi = Lokasi::findOne(['id' => $this->propinsi_id])->nama;
        $this->nama_propinsi_i = Lokasi::findOne(['id' => $this->propinsi_id_tempat_praktik_i])->nama;
        $this->nama_propinsi_ii = Lokasi::findOne(['id' => $this->propinsi_id_tempat_praktik_ii])->nama;
        ...
        if($perizinan->relasi_id){
            ...
            $preview_sk = str_replace('{nosiplama}', $perizinanParent->no_izin, $preview_sk);
            $preview_sk = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $preview_sk);
            $preview_sk = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $preview_sk);
        }
...
//        $validasi = str_replace('{saksi1_nama}', strtoupper($this->nama_saksi1), $validasi);
        ...
        if($perizinan->relasi_id){
            ...
            $validasi = str_replace('{nosiplama}', $perizinanParent->no_izin, $validasi);
        ...
        $table = '<table border=0>' . $jadwal_table1 . '</table>';
        ...
        if ($this->status_sip_offline == 'Y') {
            ...
            $preview_data = str_replace('{gedung_praktik1}', isset($this->nama_gedung_praktik_i) ? $this->nama_gedung_praktik_i : '', $preview_data);
            $preview_data = str_replace('{blok1}', isset($this->blok_tempat_praktik_i) ? $this->blok_tempat_praktik_i : '', $preview_data);
            $preview_data = str_replace('{rt_praktik1}', isset($this->rt_tempat_praktik_i) ? $this->rt_tempat_praktik_i : '', $preview_data);
            $preview_data = str_replace('{rw_praktik1}', isset($this->rw_tempat_praktik_i) ? $this->rw_tempat_praktik_i : '', $preview_data);
            $preview_data = str_replace('{kelurahan_praktik1}', isset($this->nama_kelurahan_i) ? $this->nama_kelurahan_i : '', $preview_data);
            $preview_data = str_replace('{kecamatan_praktik1}', isset($this->nama_kecamatan_i) ? $this->nama_kecamatan_i : '', $preview_data);
            $preview_data = str_replace('{kabupaten_praktik1}', isset($this->nama_kabkota_i) ? $this->nama_kabkota_i : '', $preview_data);
            $preview_data = str_replace('{propinsi_praktik1}', isset($this->nama_propinsi_i) ? $this->nama_propinsi_i : '', $preview_data);
            $no = 1;
            ...
            if ($this->jumlah_sip_offline != '1') {
                ...
                $preview_data = str_replace('{gedung_praktik2}', isset($this->nama_gedung_praktik_ii) ? $this->nama_gedung_praktik_ii : '', $preview_data);
                $preview_data = str_replace('{blok2}', isset($this->blok_tempat_praktik_ii) ? $this->blok_tempat_praktik_ii : '', $preview_data);
                $preview_data = str_replace('{rt_praktik2}', isset($this->rt_tempat_praktik_ii) ? $this->rt_tempat_praktik_ii : '', $preview_data);
                $preview_data = str_replace('{rw_praktik2}', isset($this->rw_tempat_praktik_ii) ? $this->rw_tempat_praktik_ii : '', $preview_data);
                $preview_data = str_replace('{kelurahan_praktik2}', isset($this->nama_kelurahan_ii) ? $this->nama_kelurahan_ii : '', $preview_data);
                $preview_data = str_replace('{kecamatan_praktik2}', isset($this->nama_kecamatan_ii) ? $this->nama_kecamatan_ii : '', $preview_data);
                $preview_data = str_replace('{kabupaten_praktik2}', isset($this->nama_kabkota_ii) ? $this->nama_kabkota_ii : '', $preview_data);
                $preview_data = str_replace('{propinsi_praktik2}', isset($this->nama_propinsi_ii) ? $this->nama_propinsi_ii : '', $preview_data);
                $no = 1;
                ...
                $table = '<table border=0>' . $jadwal_table3 . '</table>';
                $preview_data = str_replace('{jadwal_praktik2}', $table, $preview_data);
            } else {
                $preview_data = str_replace('{jns_praktik2}', '', $preview_data);
                $preview_data = str_replace('{nm_praktik2}', '', $preview_data);
                $preview_data = str_replace('{sip_praktik2}', '', $preview_data);
                $preview_data = str_replace('{tglsip_praktik2}', '', $preview_data);
                $preview_data = str_replace('{alamat_praktik2}', '', $preview_data);
                $preview_data = str_replace('{gedung_praktik2}', '', $preview_data);
                $preview_data = str_replace('{blok2}', '', $preview_data);
                $preview_data = str_replace('{rt_praktik2}', '', $preview_data);
                $preview_data = str_replace('{rw_praktik2}', '', $preview_data);
                $preview_data = str_replace('{kelurahan_praktik2}', '', $preview_data);
                $preview_data = str_replace('{kecamatan_praktik2}', '', $preview_data);
                $preview_data = str_replace('{kabupaten_praktik2}', '', $preview_data);
                $preview_data = str_replace('{propinsi_praktik2}', '', $preview_data);
                $preview_data = str_replace('{jadwal_praktik2}', '', $preview_data);
            }
        } else {
            $preview_data = str_replace('{jns_praktik1}', '', $preview_data);
            $preview_data = str_replace('{nm_praktik1}', '', $preview_data);
            $preview_data = str_replace('{sip_praktik1}', '', $preview_data);
            $preview_data = str_replace('{tglsip_praktik1}', '', $preview_data);
            $preview_data = str_replace('{alamat_praktik1}', '', $preview_data);
            $preview_data = str_replace('{jadwal_praktik1}', $table = '', $preview_data);
            $preview_data = str_replace('{gedung_praktik1}', '', $preview_data);
            $preview_data = str_replace('{blok1}', '', $preview_data);
            $preview_data = str_replace('{rt_praktik1}', '', $preview_data);
            $preview_data = str_replace('{rw_praktik1}', '', $preview_data);
            $preview_data = str_replace('{kelurahan_praktik1}', '', $preview_data);
            $preview_data = str_replace('{kecamatan_praktik1}', '', $preview_data);
            $preview_data = str_replace('{kabupaten_praktik1}', '', $preview_data);
            $preview_data = str_replace('{propinsi_praktik1}', '', $preview_data);
        ...
        if($perizinan->relasi_id){
            ...
            $preview_data = str_replace('{nosiplama}', $perizinanParent->no_izin, $preview_data);
        ...
        if($perizinan->relasi_id){
            ...
            $teks_sk = str_replace('{nosiplama}', $perizinanParent->no_izin, $teks_sk);
            $teks_sk = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $teks_sk);
            $teks_sk = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $teks_sk);
        }
        ...
        if($perizinan->relasi_id){
            ...
            $sk_penolakan = str_replace('{nosiplama}', $perizinanParent->no_izin, $sk_penolakan);
            $sk_penolakan = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $sk_penolakan);
            $sk_penolakan = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $sk_penolakan);
        }
        ...
        if($perizinan->relasi_id){
            ...
            $pengurusan = str_replace('{nosiplama}', $perizinanParent->no_izin, $pengurusan);
            $pengurusan = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $pengurusan);
            $pengurusan = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $pengurusan);
        }
        ...
        if($perizinan->relasi_id){
            ...
            $kuasa = str_replace('{nosiplama}', $perizinanParent->no_izin, $kuasa);
            $kuasa = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $kuasa);
            $kuasa = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $kuasa);
        }
        ...
        if($perizinan->relasi_id){
            ...
            $daftar = str_replace('{nosiplama}', $perizinanParent->no_izin, $daftar);
            $daftar = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $daftar);
            $daftar = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $daftar);
        }
...
//      ====================template_BAPL========
        ...
        if($perizinan->relasi_id){
            ...
            $bapl = str_replace('{nosiplama}', $perizinanParent->no_izin, $bapl);
            $bapl = str_replace('{tgl_sk}', $perizinanParent->tanggal_izin, $bapl);
            $bapl = str_replace('{tgl_expired}', $perizinanParent->tanggal_expired, $bapl);
        }
