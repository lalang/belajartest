...
//       
        ...
        $sk_siup = str_replace('{foto}', '<img src="' . Yii::getAlias('@front').'/'.Yii::$app->user->id. '/uploads/' . $this->perizinan->perizinanBerkas[0]->userFile->filename . '" width="120px" height="160px"/>', $sk_siup);
