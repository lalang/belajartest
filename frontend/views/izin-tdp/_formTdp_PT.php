            ...
            <div class="box-body">
                ...
                <div class="row">
                    <?php if ($model->status_id != 1) { ?>
                        <div class="col-md-6">
                            <?= $form->field($model, 'perpanjangan_ke')->textInput(['placeholder' => 'Pembaharuan izin ke']) ?>
                        </div>
                    <?php } ?>
                    <!--                    <div class="col-md-4">
                            ...
                            <div class="tab-pane" id="tab_2">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <?= $form->field($model, 'ii_2_perusahaan_propinsi')->dropDownList([ '11' => 'DKI Jakarta'], ['disabled' => true]) ?>
                                            </div>
                                            <div class="col-md-4">
                                                <?= $form->field($model, 'ii_2_perusahaan_kabupaten')->dropDownList(\backend\models\Lokasi::getKotaOptions(), ['id' => 'kabkota-id-tab2', 'class' => 'input-large form-control', 'disabled' => true, 'prompt' => 'Pilih Kota..']); ?>
                                            </div>
                                            <div class="col-md-4">
                                                <?=
                                                ...
                                                <div class="panel panel-info">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <?php // $form->field($model, 'iii_2_induk_kabupaten')->dropDownList(\backend\models\Lokasi::getKotaOptions(), ['id' => 'kabkota-id-tab3', 'class' => 'input-large form-control', 'prompt' => 'Pilih Kota..']); ?>
                                                ...
                                                <div class="panel panel-info">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <?php // $form->field($model, 'iii_3_lokasi_unit_produksi_propinsi')->dropDownList([ '11' => 'DKI Jakarta']) ?>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                ?>
                                                                <?php // $form->field($model, 'iii_3_lokasi_unit_produksi_kabupaten')->dropDownList(\backend\models\Lokasi::getKotaOptions(), ['id' => 'kabkota-opt-tab3', 'class' => 'input-large form-control', 'prompt' => 'Pilih Kota...'])->label('Kota/Kab.'); ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <?= $form->field($model, 'iv_a3_nomor')->textInput(['placeholder' => 'Nomor'])->label('<i class="glyphicon glyphicon-book"></i> PENGESAHAN MENTERI HUKUM DAN HAM') ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <?=
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <?= $form->field($model, 'iv_a4_nomor')->textInput(['placeholder' => 'Nomor'])->label('<i class="glyphicon glyphicon-book"></i> PERSETUJUAN MENTERI HUKUM DAN HAM atas Akta Perubahan Anggaran Dasar') ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <?=
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <?= $form->field($model, 'iv_a5_nomor')->textInput(['placeholder' => 'Nomor'])->label('<i class="glyphicon glyphicon-book"></i> PENERIMAAN LAPORAN PERUBAHAN ANGGARAN DASAR') ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <?=
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <?= $form->field($model, 'iv_a6_nomor')->textInput(['placeholder' => 'Nomor'])->label('<i class="glyphicon glyphicon-book"></i> PENERIMAAN PEMBERITAHUAN PERUBAHAN DIREKSI/KOMISARIS') ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <?=
                            ...
                            <div class="tab-pane" id="tab_5">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <?= $form->field($model, 'v_jumlah_dirut')->textInput(['placeholder' => 'Isi Angka'])->label('Jumlah Dirut/Dir. Cabang/Penanggungjawab') ?>
                                            </div>
                                            <div class="col-md-4">
                                                <?= $form->field($model, 'v_jumlah_direktur')->textInput(['placeholder' => 'Isi Angka'])->label('Jumlah Direktur') ?>
                                            </div>
                                            <div class="col-md-4">
                                                <?= $form->field($model, 'v_jumlah_komisaris')->textInput(['placeholder' => 'Isi Angka'])->label('Jumlah Komisaris') ?>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="tab_6">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <?= $form->field($model, 'vi_jumlah_pemegang_saham')->textInput(['placeholder' => 'Isi Angka'])->label('Jumlah Pemegang Saham <small>(Selain yang menjabat Komisaris dan Direktur)</small>') ?>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <table class="table table-condensed">
                                                <tr>
                                                    ...
                                                    <td> <?=
                                                                $form->field($model, 'vii_c1_dasar', ['inputTemplate' =>
                                                    ...
                                                    <td><?= $form->field($model, 'vii_c4_saham')->textInput(['placeholder' => 'Isi Angka'])->label('Banyaknya Saham (lbr.)') ?></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div id="optional2" <?php echo $hiden1; ?>>
                                            <div class="panel panel-info">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <?= $form->field($model, 'vii_fb_jumlah')->textInput(['placeholder' => 'Isi Angka', 'class' => 'form-control number'])->label('Kapasitas Produksi /Tahun') ?>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <?=
