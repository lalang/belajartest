...
//				}	
?>
                                            <?= $form->field($model, 'iii_5_npwp')->textInput(['maxlength' => true, 'placeholder' => 'NPWP Perusahaan', 'readonly' => $status_readonly])->hint('Diisi hanya angka (tanpa . atau -). Untuk Perorangan masukkan NPWP Perorangan') ?>

                                            <?= $form->field($model, 'ii_2_perusahaan_alamat')->textarea(['rows' => 6]) 
                                            ->hint('Diisi Nama jalan, Nomor, Rt/Rw') 
                                            ?>
                                            
                                            <?= $form->field($model, 'ii_2_perusahaan_kabupaten')->dropDownList(\backend\models\Lokasi::getKotaOptions(), ['id' => 'kabkota-id', 'class' => 'input-large form-control', 'prompt' => 'Pilih Kota..']); ?>
                                            ...
                                            <?= $form->field($model, 'ii_2_perusahaan_no_telp')->textInput(['maxlength' => true, 'placeholder' => 'Contoh : 02112345678']) ?>

                                            <?= $form->field($model, 'ii_2_perusahaan_no_fax')->textInput(['maxlength' => true, 'placeholder' => 'Fax Perusahaan']) ?>
											
                                           <?= $form->field($model, 'ii_2_perusahaan_email')->textInput(['maxlength' => true, 'placeholder' => 'Fax Perusahaan']) ?>
