...
<?php
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            ...
            'heading' => Html::encode(Yii::t('app', 'Izin Pariwisata Akta').' '. $this->title),
        ],
...
<?php
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => Html::encode(Yii::t('app', 'Izin Pariwisata Kapasitas Transport').' '. $this->title),
        ],
...
<?php
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => Html::encode(Yii::t('app', 'Izin Pariwisata Kbli').' '. $this->title),
        ],
