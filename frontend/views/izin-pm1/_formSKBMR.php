    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Surat Keterangan Belum Memiliki Rumah (SKBMR)</h3>
    ...
    <div class="pm1-form-skbmr">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#tab_3" data-toggle="tab">Saksi 1</a></li>
                <li><a href="#tab_4" data-toggle="tab">Saksi 2</a></li>
