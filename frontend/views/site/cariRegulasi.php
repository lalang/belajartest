						...
						?> 
                                <tr>
                                    ...
                                    <td style='text-align: center'>
                                       <a href="<?php echo \Yii::$app->urlManager->createAbsoluteUrl('download/regulasi/'.$value['nama_file']); ?>" class="btn btn-info" target="_blank"><i class="fa fa-download"></i> Download
                                        </a>
                                    </td>
                                </tr>
                            <?php }
