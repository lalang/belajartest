...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'check' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'time_check' => ['type' => TabularForm::INPUT_WIDGET,
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowPerizinanDokumen(' . $key . '); return false;', 'id' => 'perizinan-dokumen-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> ' . Yii::t('app', 'Perizinan Dokumen') . '  </h3>',
            'type' => GridView::TYPE_INFO,
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Row'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowPerizinanDokumen()']),
        ]
    ]
]);
Pjax::end();
