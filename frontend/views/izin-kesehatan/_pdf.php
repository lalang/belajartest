...
<?php
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            ...
            'heading' => Html::encode(Yii::t('app', 'Izin Kesehatan Jadwal').' '. $this->title),
        ],
...
<?php
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => Html::encode(Yii::t('app', 'Izin Kesehatan Jadwal Dua').' '. $this->title),
        ],
...
<?php
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => Html::encode(Yii::t('app', 'Izin Kesehatan Jadwal Satu').' '. $this->title),
        ],
