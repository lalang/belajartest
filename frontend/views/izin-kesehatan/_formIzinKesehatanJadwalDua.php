...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'hari_praktik' => ['type' => TabularForm::INPUT_TEXT,'options' => ['class' => 'hari_praktik2','placeholder' => Yii::t('app', 'Masukan nama hari')],],
        'jam_praktik' => ['type' => TabularForm::INPUT_TEXT,'options' => ['class' => 'jam_praktik2','placeholder' => Yii::t('app', 'Contoh: 08:00-17:00')],],
        'del' => [
            'type' => 'raw',
            'label' => '',
