...
use frontend\models\IzinPenelitian;

/**
 * frontend\models\IzinPenelitianSearch represents the model behind the search form about `frontend\models\IzinPenelitian`.
 */
