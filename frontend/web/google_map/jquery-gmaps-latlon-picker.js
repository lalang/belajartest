...
var GMapsLatLonPicker = (function() {
	...
	var setPosition = function(position) {
		...
		$(_self.vars.cssID + ".gllpLongitude").val(position.lng(),'E');
		$(_self.vars.cssID + ".gllpLatitude").val(position.lat(),'N');		
		$(_self.vars.cssID + ".koorLongitude").text(position.lng(),'E');
		$(_self.vars.cssID + ".koorLatitude").text(position.lat(),'N');
