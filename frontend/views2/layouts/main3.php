...
/* @var $content string */
if (Yii::$app->controller->action->id === 'login' || Yii::$app->controller->action->id === 'register' || Yii::$app->controller->action->id === 'resend') {
    echo $this->render(
        'wrapper-black',
        ['content' => $content]
    );
    ...
    <body class="skin-blue <?= $collapse ?>">11111111111
        <div class="wrapper">
            ...
            <footer class="main-footer">
                <!--<p class="pull-left"Version 2.0</p>-->
                <p class="pull-right">Developed by PTSP & Kominfo DKI</p>

                <div class="pull-right hidden-xs">
                    <b>Version</b> 1.0 &nbsp
                </div>
                <strong>&nbspCopyright © PTSP-DKI</strong> All rights reserved.
            </footer>
